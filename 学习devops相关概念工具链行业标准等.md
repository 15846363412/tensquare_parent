...
​		DevOps是一种**方法或理念**，它涵盖开发、测试、运维的整个过程。DevOps是提高软件开发、测试、运维、运营 等各部门的沟通与协作质量的方法和过程，DevOps强调软件开发人员与软件测试、软件运维、质量保障（QA）部 门之间有效的沟通与协作，强调通过自动化的方法去管理软件变更、软件集成，使软件从构建到测试、发布更加快 捷、可靠，最终按时交付软件。**简单说就是开发运维一体化**
...
​				![QQ截图20191101143851](\图片\QQ截图20191101143851.png)

# **二、工具链**

DevOps兴起于2009年，近年来由于云计算、互联网的发展，促进了DevOps的基础设施及工具链的发展，涌现了 

一大批优秀的工具，这些工具包括开发、测试、运维的各各领域，例如：**GitHub**、**Git**/SVN、**Docker**、**Jenkins**、 Hudson、Ant/**Maven**/**Gradle**、**Selenium**、**QUnit**、**JMeter**等。下图是DevOps相关的工具集：

![QQ截图20190912145631](图片\QQ截图20190912145631.png)



![QQ截图20190920154831](图片\QQ截图20190920154831.png)

**1.Git**:分布式版本控制系统

![](图片\QQ截图20190912150216.png)
...
![QQ截图20190917094751](图片\QQ截图20190917094751.png)
